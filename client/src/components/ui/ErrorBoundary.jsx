    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-warm-50">
          <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center shadow-lg border border-orange-100">
            ...
            <p className="text-sm text-gray-500 mb-6">
              We encountered an issue loading this section. Please refresh or return to the homepage.
            </p>
            <div className="flex gap-3">
              ...
              <a href="/" className="btn-outline flex-1 py-2.5 text-sm text-center">
                Home
              </a>
            </div>
          </div>
